...
A narration file looks like:
  {"lesson": "pages", "voice": "af_heart", "speed": 1.0, "lines": {"intro.1": "Text to speak."}}

build writes audio/<lesson>/<id>.mp3 plus audio/<lesson>/manifest.json ({id: {hash, ms}}).
...
def cmd_build(args):
    ...
    lesson, lines = script["lesson"], script["lines"]
