(function initializeCourseCore() {
  ...
  const lessons = [
    ...
    { id: "models", module: "Keys and data models", title: "Tables, documents, graphs", minutes: 12 },
    { id: "latency", module: "Measuring systems", title: "Latency and percentiles", minutes: 12 },
