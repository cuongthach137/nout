  ...
  function renderIndexOperations() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab incident-lab">
        ...
        <div class="lab-top"><div><span class="lab-kicker">Lab 07</span><h2>Plan the index build</h2><p class="lab-copy">Compare a standard build with PostgreSQL’s concurrent build. Scale the table, then introduce a long-running transaction and inspect the timeline.</p></div><span class="lab-badge">locks · scans · snapshots</span></div>
