(function registerBloomLesson(DSL) {
  ...
  function renderBloom() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">Lab 09</span><h2>Probe the bitset</h2><p class="lab-copy">Three stored keys set three bit positions each. Probe a key and follow its hash positions before deciding whether storage I/O is necessary.</p></div><span class="lab-badge">hash → bits → maybe</span></div>
