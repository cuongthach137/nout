(function registerWelcomeLesson(DSL) {
  ...
  const MODULE_CARDS = {
    ...
    "Writing SQL": ["Ask the tables", "Write the queries every SQL interview starts with, graded live in your browser: filter and sort, then join tables without losing rows."],
