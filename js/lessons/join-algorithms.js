  ...
  function renderJoinAlgorithms() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab incident-lab">
        ...
        <div class="lab-top"><div><span class="lab-kicker">${DSL.labLabel("join-algorithms")} · join execution</span><h2>Make three algorithms do the same join</h2><p class="lab-copy">Let the planner choose or force a plan for comparison. The visual model counts relative executor work; production costs also depend on cache state, row width, parallelism, and data distribution.</p></div><span class="lab-badge">build · probe · match</span></div>
