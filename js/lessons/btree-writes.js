(function registerBtreeWritesLesson(DSL) {
  ...
  function renderBtreeWrites() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">${DSL.labLabel("btree-writes")}</span><h2>Insert into a live B-tree</h2><p class="lab-copy">Run the same 12 inserts with random and time-ordered UUIDs. Each pulse is a leaf page touched; a split means the target page had no room.</p></div><span class="lab-badge">key → leaf → split</span></div>
