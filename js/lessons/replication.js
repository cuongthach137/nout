(function registerReplicationLesson(DSL) {
  ...
  function renderReplication() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">${DSL.labLabel("replication")} · distributed consistency</span><h2>Observe replication lag</h2><p class="lab-copy">Write a new profile name to the leader. Adjust network lag, then read from a follower before or after the update arrives.</p></div><span class="lab-badge">leader → followers</span></div>
