(function registerVacuumLesson(DSL) {
  ...
  function renderVacuum() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">${DSL.labLabel("vacuum")} · maintenance</span><h2>Reclaim a high-churn table</h2><p class="lab-copy">Generate obsolete versions, optionally pin them with an old snapshot, then compare ordinary VACUUM with the table rewrite performed by VACUUM FULL.</p></div><span class="lab-badge">visibility → reclaim</span></div>
        <div class="controls">
