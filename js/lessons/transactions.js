(function registerTransactionsLesson(DSL) {
  ...
  function renderTransactions() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">${DSL.labLabel("transactions")} · isolation</span><h2>The lost update</h2><p class="lab-copy">Two transactions read $100, then independently add $20 and $30. Choose how the database handles the collision.</p></div><span class="lab-badge">read → write → commit</span></div>
