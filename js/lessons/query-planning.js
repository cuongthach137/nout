(function registerQueryPlanningLesson(DSL) {
  ...
  function renderPlanner() {
    ...
    DSL.elements.root.innerHTML = `<article class="lesson">
      ...
      <section class="lab">
        <div class="lab-top"><div><span class="lab-kicker">Lab 11</span><h2>Cost-based query planner</h2><p class="lab-copy">Change the share of rows that match. The simplified planner estimates page work and chooses the cheaper path.</p></div><span class="lab-badge">estimate → choose</span></div>
