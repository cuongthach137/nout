...
window.ROADMAP = {
  ...
  phases: [
    ...
    { id: "p3", name: "Level 1 foundations", short: "Phase 3", items: [
      ...
      { id: "p3-window", title: "Window functions", detail: "T1 · Ranking, running totals, top-N per group.", isNew: true, status: "progress", note: "PR open: all three modes; OVER / PARTITION BY, ROW_NUMBER vs RANK vs DENSE_RANK, top N per group, running totals, LAG, frames in Explore." },
  ...
  modules: [
    ...
    { level: "Level 1", name: "SQL you’ll be asked to write", lessons: [["SELECT, filter, sort", "select", { N: "on", G: "on", E: "on" }], ["Join types", "joins", { N: "on", G: "on", E: "on" }], ["GROUP BY and HAVING", "group", { N: "on", G: "on", E: "on" }], ["Subqueries and CTEs", "sub", { N: "on", G: "on", E: "on" }], ["Window functions", "window", { N: "on", G: "on", E: "on" }], ["NULL traps"]] },
