...
window.ROADMAP = {
  ...
  phases: [
    ...
    { id: "p3", name: "Level 1 foundations", short: "Phase 3", items: [
      ...
      { id: "p3-sub", title: "Subqueries and CTEs", detail: "T1", isNew: true, status: "progress", note: "PR open: all three modes; scalar and list subqueries, correlated subqueries, EXISTS / NOT EXISTS, derived tables, CTEs, a recursive CTE in Explore." },
  ...
  modules: [
    ...
    { level: "Level 1", name: "SQL you’ll be asked to write", lessons: [["SELECT, filter, sort", "select", { N: "on", G: "on", E: "on" }], ["Join types", "joins", { N: "on", G: "on", E: "on" }], ["GROUP BY and HAVING", "group", { N: "on", G: "on", E: "on" }], ["Subqueries and CTEs", "sub", { N: "on", G: "on", E: "on" }], ["Window functions"], ["NULL traps"]] },
